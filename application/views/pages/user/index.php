  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content" style="background:#1f1f1f;">
      ...
      <div class="modal-body" style="background:#ffffff !important;">
        ...
        <p class="text-justify" style="margin-left:3%;"><i class="fas fa-cloud-download-alt"></i>&nbspExplorar Archivos: Puedes examinar las diferentes categorías existentes, asi como sus subcategorias y los archivos que contiene, con la posibilidad de dar un vistazo mediante la vista previa y descargar el que más te genere interés.</p>
        <p class="text-justify" style="margin-left:3%;"><i class="fas fa-users"></i>&nbsp&nbspColaborar con la Comunidad: Tienes la libertad de compartir tus archivos con la comunidad, si tienes material que pueda ser de ayuda a otros, bienvenido sea! una vez el contenido sea aprobado por el administrador, estará al alcance de todos.</p>
        <p class="text-justify" style="margin-left:3%;"><i class="fas fa-star"></i>&nbsp&nbspValorar Contenido: Puedes aportar tu opinión respecto a los archivos que has descargado mediante tu valoración a cada uno de ellos.</p>
        ...
        <p class="text-justify" style="margin-left:3%;"><i class="fas fa-user-edit"></i>&nbspModificar Información: Puedes cambiar la información de tu perfil, es decir modificar la información que brindaste al momento de registrarte.</p>
