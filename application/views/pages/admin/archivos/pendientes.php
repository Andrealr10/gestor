        ...
        foreach ($archivos as $archivo) { ?>
            <div class="tarjeta">
                ...
                <div class="acciones mt-2">
                    <br><br>
                    <button class="btn btn-outline-success" onclick="aprobar(<?=$archivo->id_archivo?>,'<?= $categoria->nombre ?>','<?= $subcategoria->nombre ?>')"><i class="fas fa-check fa-sm"></i>Aprobar</button>
                    <button class="btn btn-outline-danger" onclick="cancelar(<?=$archivo->id_archivo?>,'<?= $categoria->nombre ?>','<?= $subcategoria->nombre ?>')"><i class="fas fa-times fa-sm"></i> Rechazar</button>
