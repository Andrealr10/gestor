...
var animate = function () {
	...
	function animateBlob() {
		...
		tlBlob.to(blob1, speed, { morphSVG: blob3, ease: Power0.easeNone }).to(blob1, speed, { morphSVG: blob1, ease: Power0.easeNone });
	}
	...
	function happyJump() {
		...
		happyJumpTl.to(envelope, speed, { y: -20, ease: Power0.easeNone }).to(envelope, speed, { y: 0, ease: Power0.easeNone }).to(envelope, speed, { y: -10, ease: Power0.easeNone }).to(envelope, speed, { y: 0, ease: Power0.easeNone }).to(envelope, speed, { y: -5, ease: Power0.easeNone }).to(envelope, speed, { y: 0, ease: Power0.easeNone });
		return happyJumpTl;
	}
	...
	function shake() {
		...
		shakeTl.to(envelope, speed, { x: -1, ease: Power0.easeNone }).to(envelope, speed, { x: 1, ease: Power0.easeNone });
		return shakeTl;
	}
	...
	function hasUnsubscribed() {
		...
		TweenMax.to(eyebrowSadLeft, speed, { y: 10 });
		TweenMax.to(eyebrowSadRight, speed, { y: 10 });
		title.innerHTML = "¡Te has dado de baja!";
		subtitle.innerHTML = "Has anulado tu suscripción, si gustas déjanos un comentarios y dinos la razón";
	...
	function hasCancelled() {
		...
		title.innerHTML = "¡Gracias por seguir con nosotros!";
		subtitle.innerHTML = "Continúa recibiendo notificaciones y adquiriendo nuestros productos!";
		unsubscribeButton.style.display = "none";
		cancelButton.style.display = "none";
		goBackButton.style.display = "block";
		clicked = true;
	...
	function goBack() {
		...
		title.innerHTML = "Desea anular la suscripción?";
		subtitle.innerHTML = "No recibirá más mensajes ni notificaciones si anulas tu suscripción";
